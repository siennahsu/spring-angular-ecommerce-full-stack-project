...
export class CheckoutComponent implements OnInit {
  ...
  thisFirstName: string | null = null;
  thisLastName: string | null = null;
  ...
  ngOnInit(): void {
    ...
    if (userNameObservable) {
      userNameObservable.subscribe({
        next: (data) => {
          this.thisFirstName = data.firstName;
          this.thisLastName = data.lastName;
  
          // Update form values
          this.checkoutFormGroup.get('customer')?.patchValue({
            firstName: this.thisFirstName,
            lastName: this.thisLastName,
